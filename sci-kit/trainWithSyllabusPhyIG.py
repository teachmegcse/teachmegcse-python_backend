...
total time taken
4 Sketch, plot and interpret distance–time and
speed–time graphs
...
(c) accelerating
(d) decelerating
6 Calculate speed from the gradient of a straightline section of a distance–time graph
...
9.8m/s2
Supplement
9 Define acceleration as change in velocity per unit
...
observer
2 State that weight is a gravitational force on an
...
Supplement
5 Describe, and use the concept of, weight as the
...
calculations
3 Determine whether an object floats based on
density data
Supplement
...
Core
1 Know that forces may produce changes in the
...
3 Determine the resultant of two or more forces
...
motion or its speed
Supplement
9 Define the spring constant as force per unit
...
3 Apply the principle of moments to situations
with one force each side of the pivot, including
balancing of a beam
4 State that, when there is no resultant force and
...
6 Describe an experiment to demonstrate that
...
other waves
3 Know the principle of the conservation of energy
...
Core
1 Describe how useful energy may be obtained, or
...
Supplement
4 Know that radiation from the Sun is the main
source of energy for all our energy resources
except geothermal, nuclear and tidal
5 Know that energy is released by nuclear fusion in
the Sun
...
3 Describe, qualitatively, how the pressure beneath
the surface of a liquid changes with depth and
density of the liquid
Supplement
4 Recall and use the equation for the change in
...
3 Describe the pressure and the changes in pressure
of a gas in terms of the motion of its particles
and their collisions with a surface
4 Know that the random motion of microscopic
...
Core
1 Describe qualitatively, in terms of particles, the
...
of particles
4 Describe evaporation in terms of the escape of
more energetic particles from the surface of a
liquid
5 Know that evaporation causes cooling of a liquid
Supplement
6 Describe the differences between boiling and
evaporation
7 Describe how temperature, surface area and air
movement over a surface affect evaporation
8 Explain the cooling of an object in contact with
...
Supplement
2 Describe thermal conduction in all solids in terms
...
2 Know that thermal energy transfer by thermal
...
energy
5 Know what happens to an object if the rate at
...
Supplement
9 Describe how wavelength and gap size affects
...
3 State that for reflection, the angle of incidence
...
n = 1
sinc
9 Describe the use of optical fibres, particularly in
telecommunications
3.2.3 Thin lenses
Core
...
3 Draw and use ray diagrams for the formation of a
real image by a converging lens
4 Describe the characteristics of an image using the
...
Supplement
6 Draw and use ray diagrams for the formation of a
virtual image by a converging lens
7 Describe the use of a single lens as a magnifying
glass
...
2 Know the traditional seven colours of the visible
spectrum in order of frequency and in order of
wavelength
Supplement
3 Recall that visible light of a single frequency is
...
spectrum in order of frequency and in order of
wavelength
2 Know that all electromagnetic waves travel at
...
continued
Supplement
6 Know that the speed of electromagnetic waves in
a vacuum is 3.0 × 108m/s and is approximately
the same in air
Cambridge IGCSE Physics 0625 syllabus for 2023, 2024 and 2025. Subject content
...
satellites
Supplement
7 Know that many important systems of
...
waves
5 Know that the speed of sound in air is
...
waves
9 Define ultrasound as sound with a frequency
higher than 20 kHz
Supplement
12 Describe the uses of ultrasound in nondestructive testing of materials, medical scanning
...
6 Draw the pattern and direction of magnetic field
...
2 State that positive charges repel other positive
...
charges
4 Explain that charging of solids by friction involves
...
8 Describe an electric field as a region in which an
electric charge experiences a force
9 State that the direction of an electric field at a
...
Core
1 Define electromotive force (e.m.f.) as the
...
3 Define potential difference (p.d.) as the work
...
3 State, qualitatively, the relationship of the
resistance of a metallic wire to its length and to
its cross-sectional area
Supplement
4 Sketch and explain the current–voltage graphs
for a resistor of constant resistance, a filament
lamp and a diode
5 Recall and use the following relationship for a
...
E = IVt
4 Define the kilowatt-hour (kWh) and calculate
...
Supplement
2 Draw and interpret circuit diagrams containing
diodes and light-emitting diodes (LEDs), and
know how these components behave in the
circuit
4.3.2 Series and parallel circuits
Core
1 Know that the current at every point in a series
circuit is the same
...
5 State that, for a parallel circuit, the current from
...
resistances
9 Explain that the sum of the currents into a
...
Core
1 Know that the p.d. across an electrical conductor
...
Core
1 Know that a conductor moving across a magnetic
...
induced e.m.f.
Supplement
4 Know that the direction of an induced e.m.f.
opposes the change causing it
5 State and use the relative directions of force,
...
Core
1 Describe the pattern and direction of the
...
Supplement
4 State the qualitative variation of the strength
...
Supplement
2 Recall and use the relative directions of force,
magnetic field and current
3 Determine the direction of the force on beams of
charged particles in a magnetic field
4.5.5 The d.c. motor
Core
1 Know that a current-carrying coil in a magnetic
...
Core
1 Describe the construction of a simple transformer
...
transmission
Supplement
6 Explain the principle of operation of a simple
iron-cored transformer
7 Recall and use the equation for 100% efficiency
in a transformer
I
p
V
...
electrons
Supplement
3 Describe how the scattering of alpha (α) particles
...
values
7 Know the relationship between the proton
...
counts/minute
Supplement
5 Use measurements of background radiation to
...
2 Identify alpha (α), beta (β) and gamma (γ)
emissions from the nucleus by recalling:
(a) their nature
(b) their relative ionising effects
(c) their relative penetrating abilities (β+
 are
not included, β-particles will be taken to
refer to β–
)
Supplement
3 Describe the deflection of α-particles, β-particles
...
Core
1 Know that radioactive decay is a change in an
...
and random
2 State that during α-decay or β-decay, the nucleus
changes to that of a different element
Supplement
3 Know that isotopes of an element may be
radioactive due to an excess of neutrons in the
nucleus and/or the nucleus being too heavy
4 Describe the effect of α-decay, β-decay and
...
5 Use decay equations, using nuclide notation, to
...
radiation)
Supplement
2 Calculate half-life from data or decay curves
...
Core
1 State the effects of ionising nuclear radiations on
living things, including cell death, mutations and
cancer
2 Describe how radioactive materials are moved,
used and stored in a safe way
Supplement
3 Explain safety precautions for all ionising
...
2 Know that the Earth orbits the Sun once in
approximately 365 days and use this to explain
the periodic nature of the seasons
3 Know that it takes approximately one month
...
continued
Supplement
7 Know that planets, minor planets and comets
...
6 Know that the force that keeps an object in orbit
around the Sun is the gravitational attraction of
the Sun
Supplement
9 Know that the strength of the Sun’s gravitational
...
Core
1 Know that the Sun is a star of medium size,
...
Supplement
2 Know that stars are powered by nuclear reactions
